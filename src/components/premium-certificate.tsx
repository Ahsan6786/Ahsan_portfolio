      ...
      >
        ...
        <div className="absolute bottom-[-20px] left-1/2 -translate-x-1/2 z-20">
            <button
                ...
                className="relative flex items-center gap-2 px-6 py-2 bg-gradient-to-b from-yellow-500 to-yellow-700 text-black font-bold rounded-full shadow-lg shadow-yellow-500/20 transition-all duration-300 transform group-hover:scale-105 group-hover:shadow-yellow-500/40"
            >
