...
export const blogPosts: BlogPost[] = [
    {
        ...
        content: `
            <p class="text-gray-400">I was born on September 16, 2005, in a tiny village called Chaksikandar Mansurpur in Bihar. A place where mornings smelled of mitti, and evenings ended with the same old stories repeated under dim yellow bulbs.</p>
